    ...
    certifications: [
      {
        ...
        year: '2026',
        issueDate: 'Abr. 2026',
        credentialId: 'recbabxf8tfe',
        credentialUrl: 'https://verify.skilljar.com/c/recbabxf8tfe',
        skills: ['Model Context Protocol', 'MCP Servers', 'Agentic AI', 'Tool Use', 'Claude'],
      ...
      },
      {
        ...
        year: '2026',
        issueDate: 'Abr. 2026',
        credentialId: 'eqbzmqhz8xc2',
        credentialUrl: 'https://verify.skilljar.com/c/eqbzmqhz8xc2',
        skills: ['Claude Code', 'Agentic Coding', 'Terminal CLI', 'AI Workflows'],
        category: 'AI & Engineering',
        hasExternalLink: true,
      },
      {
        ...
        year: '2026',
        issueDate: 'Abr. 2026',
        credentialId: 'nwzg45hk7zt9',
        credentialUrl: 'https://verify.skilljar.com/c/nwzg45hk7zt9',
        skills: ['Prompt Engineering', 'Generative AI', 'LLM Architectures', 'AI Foundations'],
        category: 'AI & Engineering',
        hasExternalLink: true,
      },
      {
        ...
        year: '2026',
        issueDate: 'Sept. 2026',
        credentialId: 'GBV5YSJ65NLI',
        credentialUrl: 'https://www.coursera.org/account/accomplishments/records/GBV5YSJ65NLI',
        skills: ['Git', 'Branching & Merging', 'Pull Requests', 'Version Control Workflows'],
      ...
      },
      {
        ...
        year: '2025',
        issueDate: 'Jul. 2025',
        credentialId: 'WC8EY1EWRKKG',
        credentialUrl: 'https://coursera.org/verify/WC8EY1EWRKKG',
        skills: ['Python', 'SQL Relational', 'PostgreSQL', 'IBM DB2', 'Query Optimization'],
      ...
      },
      {
        ...
        year: '2024',
        issueDate: 'Ago. 2024',
        credentialId: 'DHKW52KTVPP2',
        credentialUrl: 'https://www.coursera.org/account/accomplishments/records/DHKW52KTVPP2',
      ...
      {
        id: 'rimac-hackathon',
        title: 'Hackathon RIMAC 2024',
        issuer: 'Rimac Seguros y Reaseguros',
        year: '2024',
        issueDate: 'Jun. 2024',
        credentialUrl: 'https://constancias.sg.com.mx/rimac2024/AdrianMarcelVillafanVirhuez.pdf',
        skills: ['Hackathon', 'InsurTech & FinTech', 'Rapid Prototyping', 'Team Leadership'],
        category: 'Competitions & Hackathons',
        hasExternalLink: true,
      },
      {
        id: 'linkedin-ml-cafe',
        title: 'Machine Learning con un Café',
        issuer: 'LinkedIn Learning',
        year: '2024',
        issueDate: 'Jul. 2024',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/6c8b7cf4f7936728e781cb6f25d16d0f51f0e044f58a4f4328e2bb9de08977ac/',
        skills: ['Artificial Intelligence for Business', 'Machine Learning', 'Data Strategy'],
        category: 'AI & Engineering',
        hasExternalLink: true,
      },
      {
        id: 'cinfo-unmsm',
        title: 'Curso de Herramientas Informáticas',
        issuer: 'CINFO UNMSM',
        year: '2023',
        issueDate: 'Jun. 2023',
        credentialId: '0003991-2023-UAC-CINFO-DGSU/UNMSM',
        credentialUrl: 'https://drive.google.com/file/d/1b4vQmIg9-x35UkQv1jlZprESEz0PZqRj/view',
        skills: ['Herramientas Informáticas', 'Ofimática Avanzada', 'UNMSM'],
        category: 'University & Academic',
        hasExternalLink: true,
      },
      {
        id: 'linkedin-php-especialista',
        title: 'Conviértete en especialista en desarrollo PHP',
        issuer: 'LinkedIn Learning',
        year: '2023',
        issueDate: 'Mar. 2023',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/7ece2b3eea3e4d2930d857418fdb6fa735c4482b5e25538e0f868b2bd69d0863/',
        skills: ['PHP Backend', 'Bases de Datos Relacionales', 'Arquitectura Web', 'APIs REST'],
        category: 'Backend & Web',
        hasExternalLink: true,
      },
      {
        id: 'linkedin-proyectos-web',
        title: 'Desarrollo de proyectos web avanzado',
        issuer: 'LinkedIn Learning',
        year: '2023',
        issueDate: 'Mar. 2023',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/ee9c76ad9927616f4be02ace5df1b1bd4bbe481905b0ede94792e470434a6025/',
        skills: ['Gestión de Proyectos', 'Software Architecture', 'Scrum Workflows'],
        category: 'Backend & Web',
        hasExternalLink: true,
      },
      {
        ...
        year: '2023',
        issueDate: 'Mar. 2023',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/c8371ecad69122c54ce90179ef386520d21567fe1db4e6c9e562daa45685503e/',
        skills: ['UI/UX Design', 'Design Systems', 'Interactive Prototyping', 'Figma'],
        category: 'UI/UX & Design',
        hasExternalLink: true,
      },
      {
        id: 'linkedin-php-esencial',
        title: 'PHP Esencial',
        issuer: 'LinkedIn Learning',
        year: '2023',
        issueDate: 'Feb. 2023',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/f5ba21ebb7bd096f296cca4278dfd6dc98c3c48fdcbadf5ba4500ff101c39b80/',
        skills: ['PHP', 'Backend Scripting', 'Server Operations'],
        category: 'Backend & Web',
        hasExternalLink: true,
      },
      {
        id: 'linkedin-fundamentos',
        title: 'Fundamentos esenciales de la programación',
        issuer: 'LinkedIn Learning',
        year: '2023',
        issueDate: 'Feb. 2023',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/0adb4bb31531cfc1eb65e2bfc33f7ae716a22dc0b4e0e154ce97d06d20c4ed24/',
        skills: ['Algoritmos', 'Lógica de Programación', 'Estructuras de Control'],
        category: 'Backend & Web',
        hasExternalLink: true,
      },
      {
        id: 'coursera-python-uc',
        title: 'Introducción a la programación en Python I: Aprendiendo a programar con Python',
        issuer: 'Coursera / UC Chile',
        year: '2022',
        issueDate: 'Nov. 2022',
        credentialId: 'QY33D7V6DBX6',
        credentialUrl: 'https://www.coursera.org/account/accomplishments/certificate/QY33D7V6DBX6',
        skills: ['Python', 'Estructuras de Datos', 'Algoritmos Básicos'],
        category: 'Data & Databases',
        hasExternalLink: true,
      },
      {
        ...
        year: '2022',
        issueDate: 'Nov. 2022',
        credentialId: '80859013',
        hasExternalLink: false,
        skills: ['Remote Work', 'Asynchronous Collaboration', 'Distributed Operations'],
        category: 'Agile & Remote',
      },
      {
        id: 'certiprof-scrum',
  ...
  en: {
    ...
    certifications: [
      ...
      },
      {
        ...
        credentialId: '0003991-2023-UAC-CINFO-DGSU/UNMSM',
        credentialUrl: 'https://drive.google.com/file/d/1b4vQmIg9-x35UkQv1jlZprESEz0PZqRj/view',
        skills: ['Computer Science Tools', 'Advanced Office Suites', 'UNMSM'],
        category: 'University & Academic',
        hasExternalLink: true,
      },
      {
        id: 'linkedin-php-especialista',
        title: 'PHP Development Specialist',
        issuer: 'LinkedIn Learning',
        year: '2023',
        issueDate: 'Mar. 2023',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/7ece2b3eea3e4d2930d857418fdb6fa735c4482b5e25538e0f868b2bd69d0863/',
        skills: ['PHP Backend', 'Relational Databases', 'Web Architecture', 'REST APIs'],
        category: 'Backend & Web',
        hasExternalLink: true,
      },
      {
        id: 'linkedin-proyectos-web',
        title: 'Advanced Web Projects Development',
        issuer: 'LinkedIn Learning',
        year: '2023',
        issueDate: 'Mar. 2023',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/ee9c76ad9927616f4be02ace5df1b1bd4bbe481905b0ede94792e470434a6025/',
        skills: ['Project Management', 'Software Architecture', 'Scrum Workflows'],
        category: 'Backend & Web',
        hasExternalLink: true,
      },
      {
      ...
      {
        id: 'linkedin-fundamentos',
        title: 'Essential Programming Foundations',
        issuer: 'LinkedIn Learning',
        year: '2023',
        issueDate: 'Feb. 2023',
        credentialUrl: 'https://www.linkedin.com/learning/certificates/0adb4bb31531cfc1eb65e2bfc33f7ae716a22dc0b4e0e154ce97d06d20c4ed24/',
        skills: ['Algorithms', 'Programming Logic', 'Data Structures'],
        category: 'Backend & Web',
        hasExternalLink: true,
      },
      {
        id: 'coursera-python-uc',
        title: 'Introduction to Python Programming I',
        issuer: 'Coursera / UC Chile',
        year: '2022',
        issueDate: 'Nov. 2022',
        credentialId: 'QY33D7V6DBX6',
        credentialUrl: 'https://www.coursera.org/account/accomplishments/certificate/QY33D7V6DBX6',
        skills: ['Python', 'Data Structures', 'Algorithmic Problem Solving'],
        category: 'Data & Databases',
        hasExternalLink: true,
      },
      {
